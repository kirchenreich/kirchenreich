...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KircheWikipedia.point'
        db.add_column('wikipedia_kirchewikipedia', 'point',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KircheWikipedia.point'
        db.delete_column('wikipedia_kirchewikipedia', 'point')
