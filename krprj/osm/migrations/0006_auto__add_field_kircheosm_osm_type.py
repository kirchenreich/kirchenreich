...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KircheOsm.osm_type'
        db.add_column('osm_kircheosm', 'osm_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KircheOsm.osm_type'
        db.delete_column('osm_kircheosm', 'osm_type')


    models = {
        'krunite.kirchechecks': {
            'Meta': {'object_name': 'KircheChecks'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 26, 0, 0)'}),
