...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'KircheOsm', fields ['osm_type']
        db.create_index('osm_kircheosm', ['osm_type'])


    def backwards(self, orm):
        # Removing index on 'KircheOsm', fields ['osm_type']
        db.delete_index('osm_kircheosm', ['osm_type'])
