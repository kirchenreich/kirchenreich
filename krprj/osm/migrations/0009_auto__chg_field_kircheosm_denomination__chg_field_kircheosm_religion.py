...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('osm_kircheosm', 'denomination', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'KircheOsm.religion'
        db.alter_column('osm_kircheosm', 'religion', self.gf('django.db.models.fields.TextField')(null=True))
