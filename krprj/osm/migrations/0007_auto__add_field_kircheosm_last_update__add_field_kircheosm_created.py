...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'KircheOsm.last_update'
        db.add_column('osm_kircheosm', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 30, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'KircheOsm.created'
        db.add_column('osm_kircheosm', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 30, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'KircheOsm.last_update'
        db.delete_column('osm_kircheosm', 'last_update')

        # Deleting field 'KircheOsm.created'
        db.delete_column('osm_kircheosm', 'created')
    ...
    models = {
        ...
        'osm.kircheosm': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 30, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'denomination': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
